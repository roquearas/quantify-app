      ...
      <div className="grid grid-2">
        <div className="card">
          <div className="card-header">
            ...
            <Link href="/projetos" className="btn btn-outline" style={{ fontSize: 12, padding: '4px 10px' }}>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <Link href="/orcamentos" className="btn btn-outline" style={{ fontSize: 12, padding: '4px 10px' }}>
              Ver todos <ArrowRight size={14} />
            </Link>
          </div>
