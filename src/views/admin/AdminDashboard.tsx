    ...
    <>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <div className="card-header">
          ...
          <Link href="/admin/kanban" className="btn btn-outline" style={{ fontSize: 12, padding: '4px 10px' }}>
      ...
      <div className="grid grid-2" style={{ marginBottom: 20 }}>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <Link href="/admin/kanban" className="btn btn-outline" style={{ fontSize: 11, padding: '3px 8px' }}>
              ...
              <tbody>
                {focus.map((r) => (
                  <tr key={r.id}>
                    ...
                    <td>
                      <Link href={`/admin/solicitacoes/${r.id}`} style={{ fontWeight: 600 }}>
                        {r.title}
                      </Link>
              ...
              {deadlines.map((r) => {
                ...
                return (
                  <li key={r.id} className={`deadline-item ${overdue ? 'overdue' : urgent ? 'urgent' : ''}`}>
                    <Clock size={14} />
                    <div style={{ flex: 1 }}>
                      <Link href={`/admin/solicitacoes/${r.id}`} className="deadline-title">{r.title}</Link>
      ...
      <div className="card">
        <div className="card-header">
          ...
          <Link href="/admin/agent-logs" className="btn btn-outline" style={{ fontSize: 12, padding: '4px 10px' }}>
