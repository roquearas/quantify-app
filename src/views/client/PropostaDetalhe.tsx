...
export default function PropostaDetalhe() {
  ...
  async function acceptAndProceed() {
    ...
    router.replace(`/app/propostas/${proposal.id}/pagamento?payment=${pay.id}`)
  }
  ...
  async function rejectProposal() {
    ...
    router.replace('/app/solicitacoes')
  }
  ...
  if (!proposal) {
    return (
      <div className="empty-state">
        ...
        <button className="btn btn-outline" onClick={() => router.push('/app')}>
